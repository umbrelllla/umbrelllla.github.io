...
function toHms(t) {
  ...
  function padZero(v) {
    ...
    var url = $('.GCUXF0KCBXB').text();
    /*ラベル取得GCUXF0KCEWB*/
    var labels = $('.GCUXF0KCEWB').text()
    /*ラベルからバージョン取得*/
